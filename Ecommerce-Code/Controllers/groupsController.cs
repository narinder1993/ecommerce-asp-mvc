        ...
        public List<product> Index(product obj)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    {
                        images.Add(new product() { id = (dr["Id"].ToString()), path = dr["ImagePath"].ToString(), name = (dr["Name"].ToString())});
                    }
                    else
                    {
                        images.Add(new product() { id = (dr["Id"].ToString()), path = "/Images/products/noimage.jpg", name = (dr["Name"].ToString()) });
                    }
