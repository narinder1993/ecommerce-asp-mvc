...
namespace LovelyWannabuy.Controllers
{
    public class searchController : ApiController
    {
        ...
        public List<product> Index(search obj)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@txtSearch", SqlDbType.VarChar).Value = obj.txtSearch.ToString();
                cmd.Parameters.Add("@count", SqlDbType.Int).Value = obj.count;
                cmd.Parameters.Add("@pageSize", SqlDbType.Int).Value = 12;
